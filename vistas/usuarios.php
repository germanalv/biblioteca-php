                    ...
                    <tr>
                      ...
                      <td>
                        <div class="row">
                          ...
                          <div class="col-3" >
                            <button type="button" class="btn btn-danger btn-sm pb-2" data-bs-toggle="modal" data-bs-target="#modalUsuario<?=$usuario->getId()?>">
                            ...
                            <!-- Modal -->
                            <div class="modal fade" id="modalUsuario<?=$usuario->getId()?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
