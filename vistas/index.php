        ...
        <div class="container">
            ...
            <div class="row">
              <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                <a href="prestamos-crear.php" class="btn btn-success mb-2">Registrar Préstamo</a>
              </div>
            </div>
            <div class="row">
              <?php if( !empty( $_GET['r'] ) ) { ?>
                    ...
                    <td>
                      <div class="row">
                        ...
                        <div class="col-3">
                          ...
                          <!-- Modal -->
                          <div class="modal fade" id="modalPrestamo<?=$prestamo->getId()?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog">
                              <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                  ...
                                  <form method="post" action="prestamos-eliminar.php">
                                    <input type="hidden" class="form-control" id="id" name="id" value="<?=$prestamo->getId()?>">
